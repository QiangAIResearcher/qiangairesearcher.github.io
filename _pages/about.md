...
My research interests lie in the areas of machine learning, and spans the entire theory-to-application spectrum from foundamental advances (e.g., Bayesian learning and causality analysis) to practical progress (e.g., text mining, sequential data modeling). I'm enthusiastic to understand the frontier challenges in machine learning, distill these challenges into mathematically sound formulations, and develop fully-functioning methods to tackle them. My research has been applied to text classification, information retrieval, recommender systems and misinformation detection.
